...
{\small
  ...
  US: +1 502 422 6456 /
  142 Harbor Ridge Ln N, Memphis, TN 38103, USA \\
  EU: +39 320 244 2758 /
...
%\begin{comment}
{\large
  I am a computational biologist working as an associate professor at the University of Tennessee Health Science Center in Memphis.
  ...
  %As we have developed improved methods to sequence DNA, most areas of biology can be interpreted digitally.
...
%  I grew up in Kentucky, and since then I've lived elsewhere in the US and Europe, studying at Harvard and Cambridge.
}
%\end{comment}

\begin{comment}
{\large
  I am a computational biologist. I work as an associate professor at the University of Tennessee Health Science Center in Memphis.
...
\emph{July 2024 $\to$ \underline{present {\LARGE $\ast$}}} \\
\noindent
...
\noindent
{\large \bf University of Tennessee Health Science Center, Memphis} \\
\emph{December 2020 $\to$ June 2024} \\
\noindent
...
%I study ow do we encode information into DNA efficiently---this includes questions of DNA synthesis and DNA-electrical interfaces based on graphene field effect transistors.
