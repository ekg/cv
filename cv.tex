...
{\large
  ...
  %Although my research journey began in the social sciences, my work focuses on understanding sequence variation in collections of complete genomes.
  %I build methods to understand 
  %I was drawn to computational biology because my studies in the social sciences suggested that free/open-source software communities were a context
  %n interest in free/open-source software which I developed during an ethnographic study of collaborative content creation.
  ...
  %Bioinformatics gives us tools through which we can understand genomes and in turn many aspects of living things.
  ...
  %These possibilities hint at a future in which the biological and computational are deeply linked in both directions.
}
%\end{comment}
