...
Developed tools to manipulate sequencing data and descriptions of genetic variation.%, including \textsc{vcflib}.
...
%Major contributor to the 1000 Genomes Project in variant detection, data integration, and functional interpretation, and the final project result.
...
\begin{easylist}
  \ListProperties(Hide=100, Hang=true, Progressive=3ex, Style*=$\multimap $ ,Style2*=$\bullet$ ,Style3*=$\circ$ ,Style4*=\tiny$\blacksquare$)
  & Course lead and instructor. Computational Pangenomics. Instituto Gulbenkian de Ciência. Oieras, Portugal. March 2018.
...
% {\tiny {\color{white} \cite{garrison2012haplotype,garrison2018variation}} {\color{white} \cite{10002010map,10002015global,gravel2011demographic,stewart2011comprehensive,barnett2011bamtools,10002012integrated,lee2014mosaik,khurana2013integrative,zhao2013ssw,colonna2014human,colonna2014human,chiang2015speedseq,challis2015distribution,cocca2015purging,sudmant2015integrated,computational2016computational,poznik2016punctuated,novak2016graph,novak2017genome,paten2018superbubbles,paten2017genome,dawson2017germline,novak2017graph,waszak2017germline,delaneau2014integrating,siren2018haplotype,lee2014mosaik,garg2018graph,dawson2018rkmh,novak2017genome,paten2017genome,colonna2018genomic}}}

{\tiny {\color{white} \cite{
      hickey2019genotyping,
